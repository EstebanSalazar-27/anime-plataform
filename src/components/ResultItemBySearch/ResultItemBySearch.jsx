...
export const ResultItemBySearch = ({ title, type, images, id }) => {
    ...
    return (
        <Link to={`/${params.type}/detail/${id}`} className='relative select-none flex flex-col w-[185px] sm:w-full gap-2 justify-center items-center mb-2 shadow-lg'>
            <div id="card-image" className='relative w-full bg-slate-100/95 p-1.5 rounded-sm'>
