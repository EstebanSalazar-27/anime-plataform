...
export const AsideDetail = ({ poster, members, airing }) => {
    return (
        <aside className='flex flex-col gap-4 min-w-[250px] relative lg-min:-top-52   xl-min:left-4 md:w-full'>
            <picture className=' p-1 dark:bg-stone-900  bg-slate-100 rounded-sm md-w-full shadow-2xl '>
            ...
            <div className='flex-stats gap-4'>
                <div className='relative basis-2/4 bg-slate-200 dark:bg-stone-900 shadow-lg rounded-md h-12 flex  justify-center items-center'>
                    <AddToFavorite />
                </div>
                <div className={`basis-2/4 text-slate-50 font-semibold shadow-lg rounded-md h-12 select-none flex text-lg  justify-center items-center ${airing ? "bg-green-400" : "bg-rose-600"} `}> {airing ? <h2>In Transmission</h2> : <h2>Finished</h2>} </div>
            </div>

            <div className='h-[300px] w-full dark:bg-stone-900 bg-slate-200 rounded-md'>
